...
**EQ engine**
- 8 bands: Freq 20 Hz–20 kHz, Gain ±18 dB, Q 0.1–40 (the effective ceiling
  rises with frequency — 10 below 150 Hz, ramping up to 40 above 500 Hz, since
  narrow-Q surgical cuts are far more useful in the mid/high range than on
  sub-bass), each independently switchable between **Bell, Low Shelf, High
  Shelf and Notch** from the right-click panel (Notch is gain-less — a pure
  surgical cut, its node locks to 0 dB)
